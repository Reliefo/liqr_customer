...
const JM = props => {
  ...
  return (
    <>
      <div>
        <a href="https://solutions.liqr.cc" target="_blank">
            <img style={{width:'16%', float:'left', padding: "1%"}} src='https://liqr-restaurants.s3.ap-south-1.amazonaws.com/liqr_logo.jpg' alt="liqr"/>
        </a>
